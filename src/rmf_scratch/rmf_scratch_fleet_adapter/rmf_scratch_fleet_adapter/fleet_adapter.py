...
def initialize_fleet(config_yaml, nav_graph_path, node, use_sim_time):
    ...
    # Natively support patrol for our custom fleet
    node.get_logger().info(f"Fleet [{fleet_name}] is configured to perform Patrol tasks")
    task_capabilities.append(TaskType.TYPE_PATROL)
